...
width = tighest_box(3)-tighest_box(1) + 2*mini;
height =  tighest_box(4)-tighest_box(2) + 2*mini; 
set(hfig, 'position', [p(1)-mini p(2)-mini width height]);

%% set papersize
set(hfig,'PaperUnits','centimeters');
set(hfig,'PaperSize', [width height]);
set(hfig,'PaperPositionMode', 'manual');
set(hfig,'PaperPosition',[mini mini width height]);
